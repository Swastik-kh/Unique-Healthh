...
export const Dashboard: React.FC<ExtendedDashboardProps> = (props) => {
  ...
  const renderContent = () => {
    ...
    switch (activeItem) {
      ...
      case 'immunization_tracking': return <ImmunizationTracking currentFiscalYear={currentFiscalYear} records={bachhaImmunizationRecords} garbhawatiPatients={garbhawatiPatients} generalSettings={generalSettings} currentUser={currentUser} onDeleteRecord={onDeleteBachhaImmunizationRecord} />;
      ...
      case 'report_cbimnci': return <CBIMNCIReport cbimnciRecords={cbimnciRecords} serviceSeekerRecords={serviceSeekerRecords} currentFiscalYear={currentFiscalYear} generalSettings={generalSettings} />;
      ...
      case 'report_fchv': return <FCHVCompilationReport safeOrgName={activeOrgName.trim().replace(/[.#$[\\]]/g, "_")} currentFiscalYear={currentFiscalYear} generalSettings={generalSettings} />;
