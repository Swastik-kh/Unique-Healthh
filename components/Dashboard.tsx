...
export const Dashboard: React.FC<ExtendedDashboardProps> = (props) => {
  ...
  const renderContent = () => {
    ...
    switch (activeItem) {
      ...
      case 'immunization_tracking': return <ImmunizationTracking currentFiscalYear={currentFiscalYear} records={bachhaImmunizationRecords} generalSettings={generalSettings} currentUser={currentUser} onDeleteRecord={onDeleteBachhaImmunizationRecord} />;
